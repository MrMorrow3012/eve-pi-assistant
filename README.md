...
> System, planet, route, product, schematic, CPU, and powergrid records are sourced from CCP's SDE. Link cost is reserved as a user-controlled percentage because its exact in-game load depends on placement distance and planet radius. Resource abundance, POCO taxes, and market prices are not yet calculated.
...
## Roadmap
1. Improve the colony layout recommendation and material-routing engine
2. Add exact link-distance calculation from user-drawn layouts
